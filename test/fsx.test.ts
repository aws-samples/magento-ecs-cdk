...
describe('Magento Stack with Admin, FSX, default VPC, ec2 Capacity Providers', () => {
  ...
  test('For Mandatory Infra Constructs have been created With EFS', () => {
    ...
    template.hasResourceProperties('AWS::ECS::TaskDefinition', {
      Family: 'magentoMagentoServiceAdminTaskDefMagentoServiceAdmin1FD61BFB',
      ContainerDefinitions: [
        {
          Environment: [
            { Name: 'BITNAMI_DEBUG', Value: 'true' },
            { Name: 'MAGENTO_USERNAME', Value: 'magento' },
            { Name: 'MAGENTO_ADMIN_TASK', Value: 'yes' },
            { Name: 'MAGENTO_DEPLOY_STATIC_CONTENT', Value: 'yes' },
            { Name: 'MAGENTO_SKIP_REINDEX', Value: 'no' },
            { Name: 'MAGENTO_SKIP_BOOTSTRAP', Value: 'no' },
            {
            ...
            { Name: 'MAGENTO_HOST', Value: 'magento.magento.mydomain.com' },
            { Name: 'MAGENTO_ENABLE_HTTPS', Value: 'yes' },
            { Name: 'MAGENTO_ENABLE_ADMIN_HTTPS', Value: 'yes' },
            { Name: 'MAGENTO_MODE', Value: 'production' },
            { Name: 'MAGENTO_USE_FS', Value: 'yes' },
            {
              Name: 'MAGENTO_DATABASE_HOST',
              Value: { 'Fn::GetAtt': ['MagentoAuroraCluster576B8023', 'Endpoint.Address'] },
            },
            { Name: 'MAGENTO_DATABASE_PORT_NUMBER', Value: '3306' },
            { Name: 'MAGENTO_DATABASE_USER', Value: 'magentouser' },
            { Name: 'MAGENTO_DATABASE_NAME', Value: 'magento' },
            {
              Name: 'ELASTICSEARCH_HOST',
              Value: { 'Fn::GetAtt': ['Domain66AC69E0', 'DomainEndpoint'] },
            },
            { Name: 'ELASTICSEARCH_PORT_NUMBER', Value: '443' },
            { Name: 'MAGENTO_ELASTICSEARCH_USE_HTTPS', Value: 'yes' },
            { Name: 'MAGENTO_ELASTICSEARCH_ENABLE_AUTH', Value: 'yes' },
            { Name: 'MAGENTO_ELASTICSEARCH_USER', Value: 'magento-os-master' },
            { Name: 'PHP_MEMORY_LIMIT', Value: '7G' },
